...
function AnyQuestion() {
  ...
  return (
    <div className="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 h-screen p-3 flex flex-col justify-center items-center">
      <form
      ...
      >
        <h1 className="text-4xl font-bold text-white mb-4 animate-bounce">Ask Any Question</h1>
        <textarea
          required
